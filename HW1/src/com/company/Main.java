    ...
    while (choice != 0) {
      ...
      switch (choice) {
        ...
        case 3: //add branch emp
          ...
          Branch branch = cargoSystem.getBranch(branchIndex);
          // TODO: check input
          BranchEmployee be = new BranchEmployee(name, surname, branch, cargoSystem, password);
          cargoSystem.getBranch(branchIndex).addBranchEmp(be);
      ...
      switch (choice) {
        ...
        case 3:
          ...
          if (pos.equals("sender"))
            cargoSystem.addUser(new Sender(name, surname));
          else if (pos.equals("receiver")) {
            System.out.println("Enter address: ");
            address = s.nextLine();
            cargoSystem.addUser(new Receiver(name, surname, address));
          }
          break;
        case 4:
          System.out.println("Enter customer name: ");
